...
if ($indPremio) {
    ...
    echo '<br />'."\n";
    echo 'Puedes recogerlo a partir del <strong>1 de marzo</strong> en la <strong>Capilla</strong> de la Escuela Técnica Superior de Ingenieros Industriales<br />'."\n";
...
// --- Mensaje cuando no ha habido tanta suerte
    ...
    echo 'Nos vemos el año que viene....hasta entonces, #DesgastaTusZapatillas!<br />'."\n";
}

// --- PDF con la lista de premios
echo '<a href = "./PremiosRifaVOLUNFAIR2021.pdf" target="_blank">Listado completo de premios</a><br />'."\n";
