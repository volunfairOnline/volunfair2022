...
if ($indPremio || $aBuscar==$numPremios[0]) {
    ...
    echo '<br />'."\n";
    echo 'Puedes recogerlo hasta el <strong>15 de mayo</strong> en la <strong>Capilla</strong> de la Escuela Técnica Superior de Ingenieros Industriales<br />'."\n";
...
// --- Mensaje cuando no ha habido tanta suerte
    ...
    echo 'Nos vemos el año que viene... ¡hasta entonces no te pierdas #LaMagiaDeEntregarse!<br />'."\n";
}

// --- PDF con la lista de premios
echo '<a href = "./PremiosRifaVOLUNFAIR2023.pdf" target="_blank">Listado completo de premios</a><br />'."\n";
