...
function escribe_cabecera ($es_index = 0) {
	...
	echo '<html lang="es">'."\n";
		...
		// --- Configuración
			...
			echo '<link href="' . $base_url . 'plugins/owl-carousel/owl.carousel.css" rel="stylesheet" type="text/css" />'."\n";
			...
			//echo '<link href="'.auto_version(''  . $base_url . 'base/css/o-2021.css').'" rel="stylesheet" type="text/css" />'."\n"; 					// --- Estilos feria online 2021
