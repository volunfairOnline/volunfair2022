...
<  
            ...
            <div style="text-align:right">
                <div class="col-md-10 wow animated bounceIn">
                    ...
                    <a href="v-ponentes24"><img src="./assets/base/img/volunfair/galeria/FLECHA.jpg" /><br/>2024</a> 
                        </h2>
                </div>
            </div>
        ...
        <div id="c-isotope-anchor-1" class="c-content-box c-size-md c-bg-img-center" >
            ...
            <div class="c-content-box c-size-md c-bg-white">
                <div class="container">
                    <div class="col-md-5">
                        <img src="assets\base\img\volunfair\Fotos2025\jefazos.jpg" alt="Oli y Santi" title="Oli y Santi" class="animated wow swing" width="100%" />
                        <div class="c-content-media-1 c-bordered c-center wow animated fadeInLeft" >
                            Nuestros jefes: Olivia Alarcón y Santiago Antúnez
                        </div>
                    </div>
                    <div class="col-md-7">
                        <img src="assets\base\img\volunfair\Fotos2025\equipazo.jpg" alt="Equipo 2025" title="Equipo 2025" class="animated wow swing" width="100%" />
                        <div class="c-content-media-1 c-bordered c-center wow animated fadeInRight" >
                            El equipo VOLUNFAIR 2025
                        </div>
                    </div>
                </div>
            </div>
